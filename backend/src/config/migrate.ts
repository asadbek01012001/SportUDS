...
async function runMigrations() {
  ...
  try {
    ...
    const migrationFiles = ['001_init.sql', '002_multilang.sql', '003_machines.sql', '004_teams.sql', '005_dedupe_machines.sql', '006_devices.sql', '007_ota.sql', '008_device_machine_link.sql'];
